...
AutoCut.TextTransparency = 0.150
...
AutoBuy.TextTransparency = 0.150
...
local function IYVHQUS_fake_script() -- BlueMenu.Script 
...
coroutine.wrap(IYVHQUS_fake_script)()
local function FJDN_fake_script() -- AutoCut.Script 
...
coroutine.wrap(FJDN_fake_script)()
local function STLC_fake_script() -- AutoBuy.Script 
	...
	local function startLoop()
		while isRunning do
			for _, upg in ipairs({"br1", "br2", "br4", "ir5"}) do
				local args = {
					[1] = {
						["id"] = "buyUpgrade",
						["mode"] = "max",
...
coroutine.wrap(STLC_fake_script)()
